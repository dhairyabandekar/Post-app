...
A full-stack **POSTS APP (MERN Stack)** application where users can register, log in, create posts with images, manage their own posts, and explore posts shared by other users. The project is built using **React, Tailwind CSS, Node.js, Express.js, MongoDB, and ImageKit**.
